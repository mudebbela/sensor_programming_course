...
public class StepsDBHelper extends SQLiteOpenHelper {
    ...
    public boolean createStepsEntry() {
        ...
        String todayDate = String.valueOf(mCalendar.get(Calendar.MONTH))+"/" + String.valueOf(mCalendar.get
                (Calendar.DAY_OF_MONTH)+1)+"/"+String.valueOf(mCalendar.get(Calendar.YEAR));
        ...
        try {
            ...
            if(isDateAlreadyPresent) {
                ...
                Toast.makeText(context, "New Entry",Toast.LENGTH_SHORT );
